...
const SOCIAL_LINKS = [
  {
    href: "https://twitter.com/guncelteknoloji",
    label: "Twitter",
    svg: (
  ...
  {
    href: "https://github.com/guncelteknoloji",
    label: "GitHub",
    svg: (
  ...
  {
    href: "https://linkedin.com/company/guncelteknoloji",
    label: "LinkedIn",
    svg: (
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
              Teknoloji dünyasındaki en son gelişmeleri, yapay zeka, yazılım,
              donanım ve bilim haberlerini takip edin.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {["Teknoloji", "Yapay Zeka", "Donanım", "Mobil", "Yazılım", "Bilim", "Oyun"].map(
                (cat) => (
                  <li key={cat}>
                    <Link
                      href={`/${cat.toLowerCase().replace(/\s+/g, "-").replace("i", "ı")}`}
                      className="text-sm text-zinc-600 transition-colors hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50"
                    >
                      {cat}
                    </Link>
